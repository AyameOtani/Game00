...
void GameScene::Initialize()
{
	...
	// ===== Sky =====
	if (Master::sky.model != -1)
	{
		auto* sky = new SkyBox(Master::sky.model);
		sky->SetScale(12.0f);
	}
 ...
 // 土台
	...
	// 横移動
	CreateStage(
		Master::slideStage.model,
		Master::slideStage.collision,
	...
	// 上下
	CreateStage(
		Master::updownStage.model,
		Master::updownStage.collision,
	...
	Stage* rotaBase = CreateStage(
		Master::rotaStage.model,
		Master::rotaStage.collision,
